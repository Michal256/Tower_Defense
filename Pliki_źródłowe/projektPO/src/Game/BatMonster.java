...
public class BatMonster extends Monster {
     ...
     */
    public BatMonster(String name,int health,int monstersWalkDistanceX,int monstersWalkDistanceY,int resourceReward,int monsterSize,int whichSide,int respawnTime)
    {
        super(name,3,health,monstersWalkDistanceX,monstersWalkDistanceY,resourceReward,monsterSize,whichSide,respawnTime);
        this.mainTexture=loadImage("img/bats/Bats.png");
        setMonsterCords();
