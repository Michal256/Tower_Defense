...
public class BlueSpiderMonster extends Monster {
     ...
     */
    public BlueSpiderMonster(String name,int health,int monstersWalkDistanceX,int monstersWalkDistanceY,int resourceReward,int monsterSize,int whichSide,int respawnTime)
    {
        super(name,4,health,monstersWalkDistanceX,monstersWalkDistanceY,resourceReward,monsterSize,whichSide,respawnTime);
        this.mainTexture=loadImage("img/spiders/spider02.png");
        setMonsterCords();
