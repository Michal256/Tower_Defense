...
public class GolemMonster extends Monster {
     ...
     */
    public GolemMonster(String name,int health,int monstersWalkDistanceX,int monstersWalkDistanceY,int resourceReward,int monsterSize,int whichSide,int respawnTime)
    {
        super(name,2,health,monstersWalkDistanceX,monstersWalkDistanceY,resourceReward,monsterSize,whichSide,respawnTime);
        this.mainTexture=loadImage("img/golem/Golem.png");
        setMonsterCords();
