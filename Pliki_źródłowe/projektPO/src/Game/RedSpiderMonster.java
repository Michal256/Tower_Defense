...
public class RedSpiderMonster extends Monster {
    /**
     ...
     */
    public RedSpiderMonster(String name,int health,int monstersWalkDistanceX,int monstersWalkDistanceY,int resourceReward,int monsterSize,int whichSide,int respawnTime)
    {
        super(name,4,health,monstersWalkDistanceX,monstersWalkDistanceY,resourceReward,monsterSize,whichSide,respawnTime);
        this.mainTexture=loadImage("img/spiders/spider03.png");
        setMonsterCords();
